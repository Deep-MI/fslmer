#' Read FreeSurfer surface files
#'
#' @param fname Filename of a FreeSurfer surface file.
#'
#' @return
#' The function returns a list with entries vertices and faces.
#'
#' @export
#'
#' @examples
